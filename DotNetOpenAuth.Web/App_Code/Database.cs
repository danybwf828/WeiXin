...
namespace ComputerRepair.DataAccessLayer
{
    ...
    public class Database : IDisposable
    {
        ...
        public Database()
        {
            ConnectionString = MySecurity.SDecryptString(ConfigurationManager.AppSettings["Conn"], "zjMobileDatabase");
            //ConnectionString = FtpClient_cs.Public.DESEncrypt.Decrypt(ConfigurationManager.AppSettings["DBConnectionString"]);
        }
        public Database(string cntStr)
        {
            ConnectionString = cntStr;
        }
