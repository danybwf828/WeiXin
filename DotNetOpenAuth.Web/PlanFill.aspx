<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanFill.aspx.cs" Inherits="DotNetOpenAuth.Web.PlanFill" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        <asp:Button ID="Button2" runat="server" Text="提交" Width="50%" Height="30px" BorderWidth="2px" BorderStyle="Solid" OnClick="Button2_Click" BackColor="#FFFF66" Font-Bold="True" Font-Names="微软雅黑" Font-Size="Large" ForeColor="#9900CC" type="button"/>
        <br />
        <asp:Button ID="Button1" runat="server" Text="查询" Width="50%" Height="30px" BorderWidth="2px" BorderStyle="Solid" OnClick="Button1_Click" BackColor="#FFFF66" Font-Bold="True" Font-Names="微软雅黑" Font-Size="Large" ForeColor="#9900CC" type="button" Visible="False"/>
    </form>
</body>
</html>
 <%--wx.config({
