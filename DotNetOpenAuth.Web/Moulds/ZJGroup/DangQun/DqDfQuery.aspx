<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DqDfQuery.aspx.cs" Inherits="DotNetOpenAuth.Web.Moulds.ZJGroup.DangQun.DqDfQuery" %>
...
<%--            <tr >
        ...
        <asp:Label ID="Label2" runat="server" Text="党费缴纳" BorderStyle="None"></asp:Label>
                </td>
                <td class="auto-style4">
        <asp:RadioButton ID="RadioButton4" runat="server" Checked="True" Text="全部" GroupName="2" Height="20px" Width="30%" />
        <asp:RadioButton ID="RadioButton5" runat="server" Text="已缴" GroupName="2" style="margin-bottom: 0px" Width="30%" />
        <asp:RadioButton ID="RadioButton6" runat="server" Text="未缴" GroupName="2" Width="30%" />
                </td>
            </tr>--%>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" title="参数信息">
            <asp:GridView ID="GridView1" runat="server" Width="100%" DataKeyNames="id" CellPadding="4" AutoGenerateColumns="False" BackColor="#77AEEE" BorderColor="#9900CC" BorderStyle="Groove" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" BorderWidth="2px" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                <Columns>
                    ...
                    <asp:BoundField DataField="DfId" HeaderText="DfId" >
                    <HeaderStyle CssClass="hidden" />
                    <ItemStyle CssClass="hidden" />
                    </asp:BoundField>
                    ...
                    <asp:BoundField DataField="UserDpId" ReadOnly="True" HeaderText="UserDpId">
                    <HeaderStyle CssClass="hidden" />
                    <ItemStyle CssClass="hidden" />
                    </asp:BoundField>
                    <asp:BoundField DataField="UserDpName" ReadOnly="True" HeaderText="UserDpName">
                    <HeaderStyle CssClass="hidden" />
                    <ItemStyle CssClass="hidden" />
                    </asp:BoundField>
                    <asp:BoundField DataField="UserName" ReadOnly="True" HeaderText="姓名"></asp:BoundField>
                    <asp:BoundField DataField="DangFei" HeaderText="党费">
                    <HeaderStyle CssClass="hidden" />
                    <ItemStyle CssClass="hidden" /></asp:BoundField>
                    <asp:TemplateField HeaderText="状态"><ControlStyle Width="60px" />
                                <EditItemTemplate><asp:DropDownList Width="100%" ID="ddState" runat="server" DataSource='<%# bbState()%>' DataValueField="StateValue" DataTextField="State"></asp:DropDownList></EditItemTemplate>
                                <ItemTemplate><asp:Label Width="100%" ID="lbState" runat="server" Text='<%# Bind("State") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>
                    <asp:BoundField DataField="TimeOfTurnIn" ReadOnly="True" HeaderText="缴费时期"></asp:BoundField>
                    <asp:BoundField DataField="CheckPerson" ReadOnly="True" HeaderText="确认人"></asp:BoundField>                   
                    <asp:CommandField HeaderText="删除" EditText="○" DeleteText="○" ShowDeleteButton="True" Visible="False" ><ControlStyle Width="32px" /></asp:CommandField>
                    <asp:CommandField HeaderText="编辑" UpdateText="更新" CancelText="取消" ShowEditButton="True" ><ControlStyle Width="36px" /></asp:CommandField>
                </Columns>
