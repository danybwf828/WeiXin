            ...
            <div id="wrapper" style="background-color: #fff;">
	            <div>
		            <div class="banner" style="position: relative;">
			            ...
			            <div style="position: absolute;right: 100px;bottom: 10px;color: white;">白白笨笨</div>
		            </div>
		            <div id="pullDown">
...
<script type="text/javascript">
    function cDiv() {
        var BBul = document.getElementById("thelist");
        var BBli = document.createElement("li");

        var BBdivBody = document.createElement("div");
            var BBdivLogo = document.createElement("div");
            BBdivLogo.className = "logo";<%=bbLi[11]%>
                var BBimgLogo = document.createElement("img");
                BBimgLogo.src = "<%=bbLi[11]%>";
